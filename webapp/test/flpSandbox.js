		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#yewaybillyewaybill-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"yewaybillyewaybill-display": {
								"semanticObject": "yewaybillyewaybill",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=yewaybill.yewaybill",
									"url": sap.ui.require.toUrl("yewaybill/yewaybill")
								}
							}
						}
					}

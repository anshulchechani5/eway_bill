sap.ui.define(
    ...
    function (BaseController, UIComponent, JSONModel, MessageBox) {
        ...
        return BaseController.extend("yewaybill.yewaybill.controller.InvoiceDetails", {
            onInit() {
            ...
            generateEwayBillIrn: function () {
                ...
                // var New url ="https://my405100.s4hana.cloud.sap/sap/bc/http/sap/yeway?sap-client=080" 
                var url1 = "/sap/bc/http/sap/yeway?Eway=X";
                var url2 = "&invoice=";
            ...
            generateIRN: function () {
              ...
              //New url ="https://my405100.s4hana.cloud.sap/sap/bc/http/sap/yeway?"
            ...
            onGet: function () {
               ...
               // var new url ="https://my405100.s4hana.cloud.sap/sap/bc/http/sap/yeway?sap-client=080"
                var url1 = "https://my405100.s4hana.cloud.sap/sap/bc/http/sap/yeway";
                var url2 = "Irn=X";
                var url3 = "&eway=X";
                var url4 = "&invoice=";
